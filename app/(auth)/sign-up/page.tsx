    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-normal text-[#2A2A2A] mb-3">Create an account</h1>
          <p className="text-[#4A4A4A]">Start practicing interviews today</p>
        </div>
        ...
        <p className="mt-8 text-center text-[#4A4A4A]">
          ...
          <Link href="/sign-in" className="text-[#2A2A2A] hover:underline">
            Sign in
          </Link>
        </p>
      </div>
